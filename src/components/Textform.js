...
export default function TextForm(props) {
    ...
    return (
        ...
        <div className="container my-3" style={{color: props.mode==='dark'?'white':'#042743'}}>
            ...
            <p>Total Words: {text.split(/\s+/).filter((element)=>{return element.length!==0}).length}  and Total Characters: {text.length} characters</p>
            <p>Total {0.008 *  text.split(/\s+/).filter((element)=>{return element.length!==0}).length} min to read content.</p>
            <h2>Preview</h2>
